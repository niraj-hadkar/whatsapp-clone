package fr.codecake.whatsappclone.shared.error.infrastructure.primary;
...
class BeanValidationErrorsHandler {
    ...
    private Map<String, String> buildErrors(MethodArgumentNotValidException exception) {
        return exception.getBindingResult().getFieldErrors().stream().collect(Collectors.toUnmodifiableMap(FieldError::getField, FieldError::getDefaultMessage));
    }
