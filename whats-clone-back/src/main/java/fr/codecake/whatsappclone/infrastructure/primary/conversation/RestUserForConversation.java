...
@Builder
public record RestUserForConversation(String lastName, String firstName, UUID publicId, String imageUrl, Instant lastSeen) {

    public static RestUserForConversation from(User user) {
        fr.codecake.whatsappclone.infrastructure.primary.conversation.RestUserForConversationBuilder restUserForConversationBuilder = fr.codecake.whatsappclone.infrastructure.primary.conversation.RestUserForConversationBuilder.restUserForConversation();
