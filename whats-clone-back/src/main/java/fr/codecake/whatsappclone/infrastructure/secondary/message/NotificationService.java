...
public class NotificationService {
    ...
    public void heartBeat() throws IOException {
        for (Map.Entry<String, SseEmitter> sseEmitter : emitters.entrySet()) {
            try {
                ...
                this.usersApplicationService.updatePresence(new UserPublicId(UUID.fromString(sseEmitter.getKey())));
    ...
    public void sendMessage(Object message, List<UserPublicId> usersToNotify, NotificationEventName notificationEventName) {
