...
@Builder
public record RestConversation(UUID publicId, String name, List<RestUserForConversation> members, List<RestMessage> messages) {

    public static RestConversation from(Conversation conversation) {
        fr.codecake.whatsappclone.infrastructure.primary.conversation.RestConversationBuilder restConversationBuilder = fr.codecake.whatsappclone.infrastructure.primary.conversation.RestConversationBuilder.restConversation()
