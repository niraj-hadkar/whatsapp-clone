...
public record RestConversationToCreate(Set<UUID> members, String name) {
    ...
    public static ConversationToCreate toDomain(RestConversationToCreate restConversationToCreate) {
        fr.codecake.whatsappclone.infrastructure.primary.conversation.RestConversationToCreateBuilder restConversationToCreateBuilder = fr.codecake.whatsappclone.infrastructure.primary.conversation.RestConversationToCreateBuilder.restConversationToCreate();
